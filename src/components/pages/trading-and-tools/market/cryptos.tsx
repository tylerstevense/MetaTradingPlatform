...
const Cryptos = () => {
  return (
    <div>
      {/* Banner Section */}
      <section className="bg-[url('/images/pages/trading-and-tools/CryptoTradingBanner.png')] bg-cover bg-center section">
        <div className="container flex items-center h-full">
          <h1 className="text-white">CRYPTO CURRENCY TRADING</h1>
        </div>
      </section>

      {/* Most Popular Card 1 */}
      <MostPopularCard
        image="/images/pages/trading-and-tools/crypto-currency.png"
        heading={
          <>
        ...
        paragraphs={[
          <>
            Trade Crypto with a globally recognized broker. Buy and sell Crypto through our bespoke MetaTrader 5 trading platform, and benefit from the award-winning multilingual customer support available 24/7. &nbsp;
          </>,
          <>
      ...
      <MostPopularCard
        ...
        heading={
          <>
            Why trade&nbsp;
            <span className="h2-span text-secondary">Crypto with DOYOS</span>
            &nbsp;?
          </>
        }
        paragraphs={[
          <>
            Trade Crypto on over 50+ major, cross, and exotic currency pairs, and benefit from the tightest spreads in the industry.
          </>
        ]}
        imageLeft={true}
        checkItems={[
